...
odrv.axis0.motor.config.phase_resistance = 9

odrv.axis0.motor.config.current_lim = 10.0 # This seems to have the most impact
...
time.sleep(5) # give the motor time to spin up?
